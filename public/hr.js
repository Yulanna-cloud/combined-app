...
# ШАГ 0. ПСИХОЛОГИЧЕСКИЙ ПОРТРЕТ ПОД ВАКАНСИЮ

Прежде чем строить вопросы, определи, каким должен быть кандидат психологически именно на этой позиции. Разные роли требуют разных типов личности: например, менеджеру по продажам нужны амбициозность, активность, ориентация на результат; сметчику — скрупулёзность, усидчивость, ответственность, склонность к порядку и точности. Опирайся на суть роли (характер задач, уровень самостоятельности, давление, монотонность/разнообразие, работа с людьми или с документами и т.д.), а не на шаблон.

Кратко опиши:
* Нужный психологический портрет: 2-4 ключевые личностные черты для этой роли.
* Какие мотивы (из справочника ниже) для этой роли являются желательными, а какие — рискованными или противопоказанными. Выбери 2-4 приоритетных мотива, которые важнее всего продиагностировать на интервью.

СПРАВОЧНИК МОТИВОВ (по методике Е. Адессерман, используй ТОЛЬКО эти названия и формулировки, не выдумывай других мотивов):
{MOTIVES}
...
## БЛОК 0. ПСИХОЛОГИЧЕСКИЙ ПОРТРЕТ И ПРИОРИТЕТНЫЕ МОТИВЫ

Результат Шага 0: нужный психологический портрет для роли + 2-4 приоритетных мотива с кратким обоснованием, почему именно они важны для этой позиции.
