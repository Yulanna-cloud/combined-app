...
3. 3-4 вопроса для интервью, которые помогают определить именно эти мотивы у кандидата. Не спрашивай «что вас мотивирует» в лоб — используй поведенческие и проективные вопросы: про конкретные прошлые ситуации, что вызывало энтузиазм или демотивировало, за что кандидат гордится, как реагировал на неудачи/критику/рутину. Для каждого вопроса: какой мотив проверяет; маркер наличия мотива в ответе; маркер отсутствия/противоположного мотива.

СПРАВОЧНИК МОТИВОВ (по методике Е. Адессерман):
{MOTIVES}

Ответ короткий и по делу: (1) психологический портрет, (2) приоритетные мотивы с однострочным обоснованием, (3) вопросы. Без вступлений и заключений, максимум 350 слов.`,
...
ОГРАНИЧЕНИЕ ОБЪЁМА: пиши компактно и по делу, без вступлений, повторов и общих фраз. Суммарно по всем блокам — не больше 400 слов. Это важнее полноты.`,
