...
function sbadge(s){
  const m={'В работе':'bw','Перенос собеседования':'bpurple','Трудоустроен':'bout','Подтверждён после адаптации':'bconfirm','Отказ заказчика':'br','Отказался кандидат':'brs','Не пришел на интервью':'bnv','Не вышел на работу':'bvclosed','Недозвон':'bnedozvon','Перезвон':'bperezv'};
