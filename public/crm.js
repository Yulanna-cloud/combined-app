...
const STATUSES=['В работе','Перенос собеседования','Недозвон','Перезвон','Не удалось связаться','Отказался кандидат','Отказ заказчика','Отказ, нет релевантного опыта','Не пришел на интервью','Не вышел на работу','Трудоустроен','Подтверждён после адаптации'];
...
const INACTIVE=['Отказался кандидат','Отказ заказчика','Отказ, нет релевантного опыта','Не пришел на интервью','Не вышел на работу','Трудоустроен','Подтверждён после адаптации','Не удалось связаться'];
const REFUSE_STATUSES=['Отказался кандидат','Отказ заказчика','Отказ, нет релевантного опыта','Не пришел на интервью','Не вышел на работу'];
...
function sbadge(s){
  const m={'В работе':'bw','Перенос собеседования':'bpurple','Трудоустроен':'bout','Подтверждён после адаптации':'bconfirm','Отказ заказчика':'br','Отказ, нет релевантного опыта':'brs','Отказался кандидат':'brs','Не пришел на интервью':'bnv','Не вышел на работу':'bvclosed','Не удалось связаться':'bvclosed','Недозвон':'bnedozvon','Перезвон':'bperezv'};
