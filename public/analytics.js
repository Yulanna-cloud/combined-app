const ANALYTICS = (function () {
  ...
  const STAGE_LEVELS = [
    { stage: 'Скрининг', level: 0 },
    { stage: 'Интервью HR назначено', level: 1 },
    { stage: 'Интервью HR проведено', level: 2 },
    { stage: 'Интервью заказчика назначено', level: 3 },
    { stage: 'Интервью заказчика проведено', level: 4 },
    { stage: 'Оффер', level: 5 },
    { stage: 'Обучение', level: 6 },
    { stage: 'Работает', level: 7 }
  ];
  const LEVEL_MAP = { 'Скрининг':0,'Интервью HR назначено':1,'Интервью HR проведено':2,'Интервью заказчика назначено':3,'Интервью заказчика проведено':4,'Оффер':5,'Обучение':6,'Работает':7 };
  const HIRED_STATUSES = ['Трудоустроен'];
